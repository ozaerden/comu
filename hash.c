...
/*int ayni_mi(struct hash_tablosu *h1, struct hash_tablosu *h2){
...
int main(int argc, char** argv) {
    ...
    insert_hash_table(htable,"test1");
    insert_hash_table(htable,"test2");
    insert_hash_table(htable,"test3");
    insert_hash_table(htable,"test4");
    insert_hash_table(htable,"test5");
    insert_hash_table(htable,"test6");
    insert_hash_table(htable,"test7");
    insert_hash_table(htable,"test8");
    print_hash_table(htable);

    hash_table_buyut(&htable,17,19);
    print_hash_table(htable);
    
    insert_hash_table(htable,"test9");
    insert_hash_table(htable,"test10");
    print_hash_table(htable);
